...
responsibility for the content. The complete verification code, evidence
logs and research ledger are available at Ref.~\cite{repo}, tag
\texttt{v1.2-publication-base}.
\end{acknowledgments}
...
machine checks are in the repository note and script accompanying this
theorem~\cite{repo}. \hfill$\square$
